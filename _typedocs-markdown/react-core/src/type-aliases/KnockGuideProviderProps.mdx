...
[@knocklabs/javascript](../../../modules.mdx) / [react-core/src](../index.mdx) / KnockGuideProviderProps
...
> `optional` **colorMode**: [`ColorMode`](ColorMode.mdx)
...
> `optional` **targetParams**: [`FilterStatus`](../../../react/src/index.mdx#filterstatus)
