...
[@knocklabs/javascript](../../../modules.mdx) / [client/src](../index.mdx) / Message
...
> **recipient**: [`RecipientRef`](../type-aliases/RecipientRef.mdx)
...
> **actors**: [`RecipientRef`](../type-aliases/RecipientRef.mdx)[]
...
> **status**: [`MessageDeliveryStatus`](../type-aliases/MessageDeliveryStatus.mdx)
...
> **engagement\_statuses**: [`MessageEngagementStatus`](../type-aliases/MessageEngagementStatus.mdx)[]
...
> **source**: [`NotificationSource`](NotificationSource.mdx)
