...
[@knocklabs/javascript](../../../modules.mdx) / [client/src](../index.mdx) / FeedItem
...
> **activities**: [`Activity`](Activity.mdx)\<`T`\>[]
...
> **actors**: [`Recipient`](../type-aliases/Recipient.mdx)[]
...
> **blocks**: [`ContentBlock`](../type-aliases/ContentBlock.mdx)[]
