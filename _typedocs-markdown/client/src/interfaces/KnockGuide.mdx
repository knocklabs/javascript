...
[@knocklabs/javascript](../../../modules.mdx) / [client/src](../index.mdx) / KnockGuide
...
> **steps**: [`KnockGuideStep`](KnockGuideStep.mdx)\<`TContent`\>[]
...
> **getStep**: () => `undefined` \| [`KnockGuideStep`](KnockGuideStep.mdx)\<`TContent`\>
...
`undefined` \| [`KnockGuideStep`](KnockGuideStep.mdx)\<`TContent`\>
