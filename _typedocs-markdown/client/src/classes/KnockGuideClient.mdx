...
[@knocklabs/javascript](../../../modules.mdx) / [client/src](../index.mdx) / KnockGuideClient
...
> `readonly` **targetParams**: [`KnockGuideTargetParams`](../type-aliases/KnockGuideTargetParams.mdx) = `{}`
...
> **selectGuides**\<`C`\>(`state`, `filters`): [`KnockGuide`](../interfaces/KnockGuide.mdx)\<`C`\>[]
...
[`KnockGuide`](../interfaces/KnockGuide.mdx)\<`C`\>[]

***

### selectGuide()

> **selectGuide**\<`C`\>(`state`, `filters`): `undefined` \| [`KnockGuide`](../interfaces/KnockGuide.mdx)\<`C`\>
...
`undefined` \| [`KnockGuide`](../interfaces/KnockGuide.mdx)\<`C`\>

***

### markAsSeen()

> **markAsSeen**(`guide`, `step`): `Promise`\<`undefined` \| [`KnockGuideStep`](../interfaces/KnockGuideStep.mdx)\<`any`\>\>
...
`Promise`\<`undefined` \| [`KnockGuideStep`](../interfaces/KnockGuideStep.mdx)\<`any`\>\>

***

### markAsInteracted()

> **markAsInteracted**(`guide`, `step`, `metadata?`): `Promise`\<`undefined` \| [`KnockGuideStep`](../interfaces/KnockGuideStep.mdx)\<`any`\>\>
...
> **markAsArchived**(`guide`, `step`): `Promise`\<`undefined` \| [`KnockGuideStep`](../interfaces/KnockGuideStep.mdx)\<`any`\>\>
