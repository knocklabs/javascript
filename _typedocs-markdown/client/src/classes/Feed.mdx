...
[@knocklabs/javascript](../../../modules.mdx) / [client/src](../index.mdx) / Feed
...
> `readonly` **defaultOptions**: [`FeedClientOptions`](../interfaces/FeedClientOptions.mdx)
...
> `readonly` **knock**: [`default`](default.mdx)
...
[`FeedRealTimeCallback`](../type-aliases/FeedRealTimeCallback.mdx) | [`FeedEventCallback`](../type-aliases/FeedEventCallback.mdx)
...
> **getState**(): [`FeedStoreState`](../interfaces/FeedStoreState.mdx)
...
> **markAsSeen**(`itemOrItems`): `Promise`\<[`Message`](../interfaces/Message.mdx)\<`GenericData`\>[]\>
...
`Promise`\<[`Message`](../interfaces/Message.mdx)\<`GenericData`\>[]\>

***

### markAllAsSeen()

> **markAllAsSeen**(): `Promise`\<[`BulkOperation`](../interfaces/BulkOperation.mdx)\>
...
`Promise`\<[`BulkOperation`](../interfaces/BulkOperation.mdx)\>

***

### markAsUnseen()

> **markAsUnseen**(`itemOrItems`): `Promise`\<[`Message`](../interfaces/Message.mdx)\<`GenericData`\>[]\>
...
> **markAsRead**(`itemOrItems`): `Promise`\<[`Message`](../interfaces/Message.mdx)\<`GenericData`\>[]\>
...
> **markAllAsRead**(): `Promise`\<[`BulkOperation`](../interfaces/BulkOperation.mdx)\>
...
> **markAsUnread**(`itemOrItems`): `Promise`\<[`Message`](../interfaces/Message.mdx)\<`GenericData`\>[]\>
...
> **markAsInteracted**(`itemOrItems`, `metadata?`): `Promise`\<[`Message`](../interfaces/Message.mdx)\<`GenericData`\>[]\>
...
> **markAsArchived**(`itemOrItems`): `Promise`\<[`Message`](../interfaces/Message.mdx)\<`GenericData`\>[]\>
...
> **markAllAsArchived**(): `Promise`\<[`BulkOperation`](../interfaces/BulkOperation.mdx)\>
...
> **markAllReadAsArchived**(): `Promise`\<[`BulkOperation`](../interfaces/BulkOperation.mdx)\>
...
> **markAsUnarchived**(`itemOrItems`): `Promise`\<[`Message`](../interfaces/Message.mdx)\<`GenericData`\>[]\>
