...
export type ContentTypesMapping = {
  key?: Record<string, Any>;
  type?: Record<string, Any>;
};

export type MatchContentType<
  M extends ContentTypesMapping,
  F extends SelectFilterParams,
> = F extends { key: infer K extends string }
  ? M extends { key: infer Keys }
    ? K extends keyof Keys
      ? Keys[K]
      : Any
    : Any
  : F extends { type: infer T extends string }
    ? M extends { type: infer Types }
