...
> = ({ children, className, ...props }) => {
  return (
    <div className={clsx("knk-banner", className)} {...props}>
      {children}
    </div>
  );
};
...
> = ({ children, className, ...props }) => {
  return (
    <div className={clsx("knk-banner__message", className)} {...props}>
      {children}
    </div>
  );
};
...
> = ({ title, className, ...props }) => {
  return (
    <div className={clsx("knk-banner__title", className)} {...props}>
      {title}
    </div>
  );
};
...
const Body: React.FC<{ body: string } & React.ComponentPropsWithRef<"div">> = ({
  ...
  return (
    <div className={clsx("knk-banner__body", className)} {...props}>
      {body}
    </div>
  );
};
...
> = ({ children, className, ...props }) => {
  return (
    <div className={clsx("knk-banner__actions", className)} {...props}>
      {children}
    </div>
  );
};
...
> = ({ text, action, className, ...props }) => {
  return (
    <a
      href={action}
      className={clsx("knk-banner__action", className)}
      {...props}
    >
      {text}
    </a>
...
> = ({ text, action, className, ...props }) => {
  return (
    <a
      href={action}
      className={clsx(
        "knk-banner__action knk-banner__action--secondary",
        className,
      )}
      {...props}
    >
...
const DismissButton: React.FC<React.ComponentPropsWithRef<"button">> = ({
  ...
  return (
    <button className={clsx("knk-banner__close", className)} {...props}>
      <svg
